...
/*        lidar2camera_R << 0.9994, -0.006152, 0.034226, -0.034151, 0.011869, 0.99935, -0.0065542, -0.99991, 0.01165;
        ...
        boundary_box_filter_.setMin(Eigen::Vector4f(-20, -20, -LidarHigh - 0.2, 1.0));
        ...
        nearby_box_filter_.setMin(Eigen::Vector4f(-1, -0.5, -0.5, 1.0));
        nearby_box_filter_.setMax(Eigen::Vector4f(1, 0.5, 0.5, 1.0));
